...
public class TicketController {
	...
	public ResponseEntity<?> submitTicket(@Valid @RequestBody TicketRequest ticketRequest, @AuthenticationPrincipal UserDetails userDetails) {
	    try {
	        ...
	        if (userDetails != null) {
	            ...
	            if (optionalUser.isPresent()) {
	                ...
	                ticket.setCategory(Collections.singleton(category));
	        ...
	        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(new ApiResponse(false, "Database error: " + e.getMessage()));

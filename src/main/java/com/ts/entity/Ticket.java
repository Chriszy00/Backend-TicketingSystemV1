...
public class Ticket {
	...
	public Ticket(Long ticketId, String title, String description, User creator, User assignedUser, String status,
	...
	public Ticket(Long ticketId, String title, String description, Category category_id, Priority priority_id,
			User creator, User assignedUser, String status, String photoURL, Set<Category> categories,
